...
class Bee():
    ...
    def sample_flowers_list(self):
        random_flowers_list = random.sample(self.flowers_list,len(self.flowers_list))
        return random_flowers_list
    ...
    def gathering_distance(self):
        ...
        for flower in self.sample_flowers_list():
